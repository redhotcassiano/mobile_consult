...
class ListConsultorios extends StatefulWidget {
  @override
  _HomeState createState() => new _HomeState();
}

class _HomeState extends State<ListConsultorios> {
  ...
  Future<List> getData() async {
      ...
      final response = await http.get(baseUrl + "/consultorios", headers: header);
